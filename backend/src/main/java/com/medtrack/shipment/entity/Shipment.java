...
public class Shipment extends BaseEntity {
    ...
    public Shipment(String n, StockTransfer t, String carrier, String tracking, String driver, String phone, String vehicle, Instant eta) {
        shipmentNumber = n;
        transfer = t;
        origin = t.getSourceWarehouse();
        destination = t.getDestinationWarehouse();
        carrierName = carrier;
    ...
    public Warehouse getOrigin() { return origin; }
